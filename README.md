...
I'm a passionate **Frontend & Full-Stack Engineer** dedicated to crafting lightning-fast, high-performance web applications with exceptional user experiences. 
...
<div align="center">
  <br />
  <img src="https://github-readme-stats.vercel.app/api?username=NguyenDangKhuong&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="Khuong's GitHub Stats" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=NguyenDangKhuong&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" width="48%" />
  <br /><br />
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=NguyenDangKhuong&theme=tokyonight&hide_border=true" alt="GitHub Streak" width="97%" />
</div>
...
| :--- | :--- | :--- |
| **🛍️ Shop Management System** | Complete full-stack enterprise e-commerce platform & management system with automated inventory, order processing, and social media integration. | `Next.js 15` `React 18` `MongoDB` `TailwindCSS` `Sentry` |
| **📚 Daily English & Spaced Repetition** | Smart vocabulary & phrase learning app using SM-2 algorithm, automated Web Push notifications, and multi-AI fallback translation engine. | `Next.js` `TypeScript` `SM-2 Algorithm` `WebPush` `AI Models` |
| **🤖 Social Media Auto Post & Analytics** | Automated multi-platform video/content posting, analytics pipeline, and background queue workers. | `Node.js` `Docker` `Redis` `Vercel` `Oracle VPS` |
...
<div align="center">
  <sub>Designed with ❤️ by Khuong Nguyen. Thanks for stopping by!</sub>
</div>
